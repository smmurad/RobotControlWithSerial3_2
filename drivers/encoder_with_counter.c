...
static const nrf_drv_timer_t m_timer_count_left = NRF_DRV_TIMER_INSTANCE(1);
static const nrf_drv_timer_t m_timer_count_right = NRF_DRV_TIMER_INSTANCE(2);
